    ...
    <div className="max-w-screen-xl px-4 sm:px-8 md:px-16">
      <div className="inline-block pt-20 2xl:pt-32 pb-16 text-blue-gray-500">
        ...
        <div className="grid grid-cols-2 gap-8 mt-8">
          <div>
            <p className="font-bold text-xs uppercase tracking-widest text-blue-gray-700">Rechtliches</p>
            <ul className="mt-1">
              <li className="block transition-all duration-300 hover:text-blue-gray-400"><Link href="">Impressum</Link></li>
              <li className="block transition-all duration-300 hover:text-blue-gray-400"><Link href="">Datenschutz</Link></li>
              <li className="block transition-all duration-300 hover:text-blue-gray-400"><Link href="">Cookies</Link></li>
            </ul>
          </div>
          <div>
            <p className="font-bold text-xs uppercase tracking-widest text-blue-gray-700">Sonstiges</p>
            <ul className="mt-1">
              <li className="block transition-all duration-300 hover:text-blue-gray-400"><Link href="">Blog</Link></li>
              <li className="block transition-all duration-300 hover:text-blue-gray-400"><Link href="">Cheatsheet</Link></li>
              <li className="block transition-all duration-300 hover:text-blue-gray-400"><Link href="">Kostenrechner</Link></li>
            </ul>
          </div>
        </div>
        <ul className="flex mt-8 text-blue-gray-700">
          <li>
            <button onClick={scroll.scrollToTop} className="focus:outline-none"><svg className="fill-current h-6 mr-4 text-cool-gray-200 block transition-all duration-300 transform hover:text-teal-300 hover:scale-110" viewBox="0 0 512 512"><path fill="currentColor" d="M8 256C8 119 119 8 256 8s248 111 248 248-111 248-248 248S8 393 8 256zm292 116V256h70.9c10.7 0 16.1-13 8.5-20.5L264.5 121.2c-4.7-4.7-12.2-4.7-16.9 0l-115 114.3c-7.6 7.6-2.2 20.5 8.5 20.5H212v116c0 6.6 5.4 12 12 12h64c6.6 0 12-5.4 12-12z"></path></svg></button>
          </li>
          <li>
            <Link href=""><svg className="fill-current h-6 mr-4 cursor-pointer block transition-all duration-300 transform hover:text-blue-gray-500 hover:scale-110" viewBox="0 0 448 512"><path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"></path></svg></Link>
          </li>
          <li>
